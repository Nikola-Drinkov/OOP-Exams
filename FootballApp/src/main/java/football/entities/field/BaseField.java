...
public abstract class BaseField implements Field{
    ...
    public void setName(String name) {
        if(name==null || name.trim().isEmpty()) throw new NullPointerException(FIELD_NAME_NULL_OR_EMPTY);
        this.name = name;
    }
    ...
    public void addPlayer(Player player) {
        if(players.size()==capacity) throw new IllegalStateException(NOT_ENOUGH_CAPACITY);
        players.add(player);
    }
